...
/**
 * Autonomous program for putting climbers in the shelter and going up the blue ramp on visitor side
 *
...
public class T9015Auto_B_VisitorClimberRamp extends T9015Hardware {
    private int v_state;
    ...
    public T9015Auto_B_VisitorClimberRamp(){
