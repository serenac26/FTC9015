 ...
 */
public class T9015Telemetry extends T9015Hardware

{
...

    {
        ...
        telemetry.addData
                ( "01"
                        , "Front Left Drive: "
                                + a_f_left_drive_power()
                                + ", "
                                + a_f_left_encoder_count()
                );
        telemetry.addData
                ( "02"
                        , "Front Right Drive: "
                                + a_f_right_drive_power()
                                + ", "
                                + a_f_right_encoder_count()
                );
        telemetry.addData
                ( "03"
                        , "Rear Left Drive: "
                                + a_r_left_drive_power()
                                + ", "
                                + a_r_left_encoder_count()
                );
        telemetry.addData
                ( "04"
                        , "Rear Right Drive: "
                                + a_r_right_drive_power()
                                + ", "
